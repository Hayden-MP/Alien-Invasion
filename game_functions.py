...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets): # Respond to key presses and mouse events
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    for bullet in bullets.copy(): # Create a copy of bullets to iterate
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0: # If all aliens are shot
...
def check_fleet_edges(ai_settings, aliens):
    """Respond appropriately if any aliens have reached an edge of the window"""
